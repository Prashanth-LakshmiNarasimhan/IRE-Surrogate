...
% Calculate RMSE for GP, PCK and GP-custom (Table - 4 & B.5)
% -----------------------------------------------------------
if ismember(3,plots)
...
% Compare GP, PCK and GP-custom against Validation data points (Figure - 5 & B.7)
% --------------------------------------------------------------------------------
if ismember(4,plots)
    modlchoice = 1:9; % Choice based on the variable "metaModels"
    % Set modlchoice as 12 for Figure 5  and  1:9 for Figure B.7 when all
...
% Compare GP, PCK and GP-custom for different FEM data configurations (Figure - 6)
% ---------------------------------------------------------------------------------
if ismember(5,plots)
